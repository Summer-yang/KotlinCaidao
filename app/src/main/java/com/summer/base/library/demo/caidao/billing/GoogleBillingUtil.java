package com.summer.base.library.demo.caidao.billing;
...
public class GoogleBillingUtil {
    ...
    public GoogleBillingUtil build(Application application) {
        if (mBillingClient == null) {
            synchronized (mGoogleBillingUtil) {
                if (mBillingClient == null) {
                    mBillingClient = BillingClient.newBuilder(application.getApplicationContext()).setListener(mGoogleBillingUtil.new MyPurchasesUpdatedListener()).build();
                }
            }
        }
        synchronized (mGoogleBillingUtil) {
