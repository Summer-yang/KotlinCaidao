package com.summer.caidao.encryption;


import com.summer.caidao.base64.BaseEncodeUtil;
...
public class CaiDaoEncryptionUtil {
    ...
    public static String encryptMD5File2String(File file) {
        byte[] fileByte = encryptMD5File(file);
        if (null == fileByte) {
            return "";
        } else {
            return bytes2HexString(fileByte);
        }
    }
    ...
    public static byte[] encryptDES2Base64(byte[] data, byte[] key) {
        return BaseEncodeUtil.base64Encode(encryptDES(data, key));
    }
    ...
    public static byte[] decryptBase64DES(byte[] data, byte[] key) {
        return decryptDES(BaseEncodeUtil.base64Decode(data), key);
    }
    ...
    public static byte[] encrypt3DES2Base64(byte[] data, byte[] key) {
        return BaseEncodeUtil.base64Encode(encrypt3DES(data, key));
    }
    ...
    public static byte[] decryptBase64_3DES(byte[] data, byte[] key) {
        return decrypt3DES(BaseEncodeUtil.base64Decode(data), key);
    }
    ...
    public static byte[] encryptAES2Base64(byte[] data, byte[] key) {
        return BaseEncodeUtil.base64Encode(encryptAES(data, key));
    }
    ...
    public static byte[] decryptBase64AES(byte[] data, byte[] key) {
        return decryptAES(BaseEncodeUtil.base64Decode(data), key);
    }
