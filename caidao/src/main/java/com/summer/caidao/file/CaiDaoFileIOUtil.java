package com.summer.caidao.file;
...
public class CaiDaoFileIOUtil {

    private CaiDaoFileIOUtil() {
    ...
    public static boolean writeFileFromIS(String filePath, final InputStream is) {
        return writeFileFromIS(CaiDaoFileUtil.getFileByPath(filePath), is, false);
    }
    ...
    public static boolean writeFileFromIS(String filePath, final InputStream is, boolean append) {
        return writeFileFromIS(CaiDaoFileUtil.getFileByPath(filePath), is, append);
    }
    ...
    public static boolean writeFileFromIS(File file, final InputStream is, boolean append) {
        if (!CaiDaoFileUtil.createOrExistsFile(file) || is == null) return false;
        ...
        try {
            ...
            CaiDaoIOCloseUtil.closeIO(is, os);
        }
    }
    ...
    public static boolean writeFileFromBytesByStream(String filePath, final byte[] bytes) {
        return writeFileFromBytesByStream(CaiDaoFileUtil.getFileByPath(filePath), bytes, false);
    }
    ...
    public static boolean writeFileFromBytesByStream(String filePath, final byte[] bytes, boolean append) {
        return writeFileFromBytesByStream(CaiDaoFileUtil.getFileByPath(filePath), bytes, append);
    }
    ...
    public static boolean writeFileFromBytesByStream(File file, final byte[] bytes, boolean append) {
        if (bytes == null || !CaiDaoFileUtil.createOrExistsFile(file)) return false;
    ...
    public static boolean writeFileFromBytesByChannel(String filePath, final byte[] bytes, boolean isForce) {
        return writeFileFromBytesByChannel(CaiDaoFileUtil.getFileByPath(filePath), bytes, false, isForce);
    }
    ...
    public static boolean writeFileFromBytesByChannel(String filePath, final byte[] bytes, boolean append, boolean isForce) {
        return writeFileFromBytesByChannel(CaiDaoFileUtil.getFileByPath(filePath), bytes, append, isForce);
    }
    ...
    public static boolean writeFileFromBytesByMap(String filePath, final byte[] bytes, boolean append, boolean isForce) {
        return writeFileFromBytesByMap(CaiDaoFileUtil.getFileByPath(filePath), bytes, append, isForce);
    }
    ...
    public static boolean writeFileFromString(String filePath, String content) {
        return writeFileFromString(CaiDaoFileUtil.getFileByPath(filePath), content, false);
    }
    ...
    public static boolean writeFileFromString(String filePath, String content, boolean append) {
        return writeFileFromString(CaiDaoFileUtil.getFileByPath(filePath), content, append);
    }
    ...
    public static boolean writeFileFromString(File file, String content, boolean append) {
        ...
        if (!CaiDaoFileUtil.createOrExistsFile(file)) return false;
    ...
    public static List<String> readFile2List(String filePath) {
        return readFile2List(CaiDaoFileUtil.getFileByPath(filePath), null);
    }
    ...
    public static List<String> readFile2List(String filePath, String charsetName) {
        return readFile2List(CaiDaoFileUtil.getFileByPath(filePath), charsetName);
    }
    ...
    public static List<String> readFile2List(String filePath, int st, int end) {
        return readFile2List(CaiDaoFileUtil.getFileByPath(filePath), st, end, null);
    }
    ...
    public static List<String> readFile2List(String filePath, int st, int end, String charsetName) {
        return readFile2List(CaiDaoFileUtil.getFileByPath(filePath), st, end, charsetName);
    }
    ...
    public static List<String> readFile2List(File file, int st, int end, String charsetName) {
        if (!CaiDaoFileUtil.isFileExists(file)) return null;
        ...
        try {
            ...
            CaiDaoIOCloseUtil.closeIO(reader);
        }
    }
    ...
    public static String readFile2String(String filePath) {
        return readFile2String(CaiDaoFileUtil.getFileByPath(filePath), null);
    }
    ...
    public static String readFile2String(String filePath, String charsetName) {
        return readFile2String(CaiDaoFileUtil.getFileByPath(filePath), charsetName);
    }
    ...
    public static byte[] readFile2BytesByStream(String filePath) {
        return readFile2BytesByStream(CaiDaoFileUtil.getFileByPath(filePath));
    }
    ...
    public static byte[] readFile2BytesByStream(File file) {
        ...
        try {
            ...
            CaiDaoIOCloseUtil.closeIO(fis, os);
        }
    }
    ...
    public static byte[] readFile2BytesByChannel(String filePath) {
        return readFile2BytesByChannel(CaiDaoFileUtil.getFileByPath(filePath));
    }
    ...
    public static byte[] readFile2BytesByMap(String filePath) {
        return readFile2BytesByMap(CaiDaoFileUtil.getFileByPath(filePath));
    }
    ...
    public static void setBufferSize(int bufferSize) {
        CaiDaoFileIOUtil.sBufferSize = bufferSize;
    }
