...
class CaiDaoBehaviorBottomNavigationView() : CoordinatorLayout.Behavior<View>() {
    ...
    override fun onDependentViewChanged(parent: CoordinatorLayout, child: View, dependency: View): Boolean {
        //得到依赖View的滑动距离
        val offset = ((dependency.layoutParams as CoordinatorLayout.LayoutParams).behavior as com.google.android.material.appbar.AppBarLayout.Behavior).topAndBottomOffset
