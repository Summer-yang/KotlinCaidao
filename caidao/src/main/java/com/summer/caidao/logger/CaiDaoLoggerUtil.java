package com.summer.caidao.logger;

import android.content.Context;
import android.os.Environment;
import android.util.Log;

import com.summer.caidao.BuildConfig;
...
public class CaiDaoLoggerUtil {
    ...
    public static class Builder {
        public Builder(Context context) {
            if (defaultDir == null) {
                if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) && null != context.getExternalCacheDir()) {
        ...
        public Builder setLogSwitch(boolean logSwitch) {
            CaiDaoLoggerUtil.sLogSwitch = logSwitch;
            return this;
        }

        public Builder setConsoleSwitch(boolean consoleSwitch) {
            CaiDaoLoggerUtil.sLog2ConsoleSwitch = consoleSwitch;
            return this;
        }

        public Builder setGlobalTag(final String tag) {
            if (isSpace(tag)) {
                CaiDaoLoggerUtil.sGlobalTag = BuildConfig.APPLICATION_ID;
                sTagIsSpace = false;
            } else {
                CaiDaoLoggerUtil.sGlobalTag = tag;
                sTagIsSpace = false;
            }
            return this;
        }
        ...
        public Builder setLogHeadSwitch(boolean logHeadSwitch) {
            CaiDaoLoggerUtil.sLogHeadSwitch = logHeadSwitch;
            return this;
        }

        public Builder setLog2FileSwitch(boolean log2FileSwitch) {
            CaiDaoLoggerUtil.sLog2FileSwitch = log2FileSwitch;
            return this;
        }

        public Builder setDir(final String dir) {
            if (isSpace(dir)) {
                CaiDaoLoggerUtil.dir = null;
            } else {
                CaiDaoLoggerUtil.dir = dir.endsWith(FILE_SEP) ? dir : dir + FILE_SEP;
            }
            return this;
        }

        public Builder setDir(final File dir) {
            CaiDaoLoggerUtil.dir = dir == null ? null : dir.getAbsolutePath() + FILE_SEP;
            return this;
        }

        public Builder setBorderSwitch(boolean borderSwitch) {
            CaiDaoLoggerUtil.sLogBorderSwitch = borderSwitch;
            return this;
        }

        public Builder setConsoleFilter(@TYPE int consoleFilter) {
            CaiDaoLoggerUtil.sConsoleFilter = consoleFilter;
            return this;
        }

        public Builder setFileFilter(@TYPE int fileFilter) {
            CaiDaoLoggerUtil.sFileFilter = fileFilter;
            return this;
        }
